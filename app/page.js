    ...
    <main>
      <section className="hero">
        <div className="wrap">
          ...
          <a className="btn" href="#download">다운로드 준비 중</a>
        </div>
      </section>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <div className="grid">
            <div className="card">
              <b>PPT · 자막</b>
              <p className="muted">예배 PPT와 자막 운영</p>
            </div>
            <div className="card">
              <b>멀티 카메라</b>
              <p className="muted">카메라 1~4 실시간 확인 및 선택</p>
            </div>
            <div className="card">
              <b>YouTube 송출</b>
              <p className="muted">유튜브 방송 송출 관리</p>
            </div>
            <div className="card">
              <b>방송 상태 확인</b>
              <p className="muted">방송 흐름을 한 화면에서 확인</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="download">
        <div className="wrap">
          ...
          <div className="card">
            <b>최신 버전 준비 중</b>
            <p className="muted">배포 가능한 ChurchStudio가 확정되면 공식 다운로드가 활성화됩니다.</p>
          </div>
        </div>
      </section>
